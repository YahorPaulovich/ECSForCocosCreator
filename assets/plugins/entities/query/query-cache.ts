...
import type { SchemaOrNull } from "../types";
import type { QueryResultPool } from "./query-pool";
...
export class QueryCache {
	...
	getEntities(queryId: string, compute: () => BooleanArray, lastVersion: number): BooleanArray {
		if (lastVersion < this.#globalVersion) {
