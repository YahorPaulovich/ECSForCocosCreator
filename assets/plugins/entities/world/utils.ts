import { isValidComponentArray } from "../component/component";
import { WorldStateError } from "../errors";
import type { WorldSpec, WorldState } from "../types";
import { isObject, isPositiveUint32 } from "../utils";
